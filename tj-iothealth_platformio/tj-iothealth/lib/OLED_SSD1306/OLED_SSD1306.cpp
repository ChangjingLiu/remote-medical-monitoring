...
/*--  文字:  败  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
static const unsigned char PROGMEM bai4[] =
    {
...
void OLED_SSD1306::drawfail(boolean flag)
{

    if (flag == 1)
    {
        OLED_SSD1306::drawBitmap(59, 30, ce4, 16, 16, 1);    //在坐标X:26  Y:16的位置显示中文字符心
        OLED_SSD1306::drawBitmap(75, 30, liang2, 16, 16, 1); //在坐标X:42  Y:16的位置显示中文字符率
        OLED_SSD1306::drawBitmap(91, 30, shi1, 16, 16, 1);   //在坐标X:26  Y:16的位置显示中文字符心
        OLED_SSD1306::drawBitmap(103, 30, bai4, 16, 16, 1);  //在坐标X:42  Y:16的位置显示中文字符率
    }
